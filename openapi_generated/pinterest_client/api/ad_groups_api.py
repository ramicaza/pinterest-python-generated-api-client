...
class AdGroupsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.ad_groups_audience_sizing_endpoint = _Endpoint(
            settings={
                'response_type': (AdGroupAudienceSizingResponse,),
                'auth': [
                    'pinterest_oauth2'
                ],
                'endpoint_path': '/ad_accounts/{ad_account_id}/ad_groups/audience_sizing',
                'operation_id': 'ad_groups_audience_sizing',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'ad_account_id': 'path',
                    'ad_group_audience_sizing_request': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def ad_groups_audience_sizing(
        ...
        **kwargs
        ...
        >>> thread = api.ad_groups_audience_sizing(ad_account_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            ad_group_audience_sizing_request (AdGroupAudienceSizingRequest): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['ad_account_id'] = \
            ad_account_id
        return self.ad_groups_audience_sizing_endpoint.call_with_http_info(**kwargs)
