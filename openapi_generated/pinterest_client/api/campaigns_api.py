    ...
    def campaign_targeting_analytics_get(
        ...
        **kwargs
        ...
        Args:
            ...
            targeting_types ([AdsAnalyticsCampaignTargetingType]): Targeting type breakdowns for the report. The reporting per targeting type <br> is independent from each other. [\"AGE_BUCKET_AND_GENDER\"] is in BETA and not yet available to all users.
