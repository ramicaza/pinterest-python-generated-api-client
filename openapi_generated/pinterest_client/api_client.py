...
from openapi_generated.pinterest_client import rest
from openapi_generated.pinterest_client.configuration import Configuration
from openapi_generated.pinterest_client.exceptions import ApiTypeError, ApiValueError, ApiException
from openapi_generated.pinterest_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
DEFAULT_USER_AGENT = 'pins-generated-client/python/0.1.4'
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.default_headers = {
            'X-Pinterest-App-Type-Detailed': self.app_type_detailed
        }
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AdAccountsApi()
        api_instance.ad_account_analytics  # this is an instance of the class Endpoint
        api_instance.ad_account_analytics()  # this invokes api_instance.ad_account_analytics.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.ad_account_analytics.callable or self.callable in this class
