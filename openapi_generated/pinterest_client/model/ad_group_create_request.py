...
class AdGroupCreateRequest(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'targeting_template_ids': ([str], none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'targeting_template_ids': 'targeting_template_ids',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            lifetime_frequency_cap (int): Set a limit to the number of times a promoted pin from this campaign can be impressed by a pinner within the past rolling 30 days. Only available for CPM (cost per mille (1000 impressions))  ad groups. A CPM ad group has an IMPRESSION <a href=\"/docs/redoc/#section/Billable-event\">billable_event</a> value. This field **REQUIRES** the `end_time` field.. [optional]  # noqa: E501
            ...
            auto_targeting_enabled (bool): [optional]  # noqa: E501
            placement_group (str): <a href=\"/docs/redoc/#section/Placement-group\">Placement group</a>.. [optional]  # noqa: E501
            pacing_delivery_type (str): [optional] if omitted the server will use the default value of "STANDARD"  # noqa: E501
            bid_strategy_type (str, none_type): Bid strategy type. For Campaigns with Video Completion objectives, the only supported bid strategy type is AUTOMATIC_BID.. [optional]  # noqa: E501
            targeting_template_ids ([str], none_type): Targeting template IDs applied to the ad group. We currently only support 1 targeting template per ad group. To use targeting templates, do not set any other targeting fields: targeting_spec, tracking_urls, auto_targeting_enabled, placement_group. To clear all targeting template IDs, set this field to ['0'].. [optional]  # noqa: E501
        """
