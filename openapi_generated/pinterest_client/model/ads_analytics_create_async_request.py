...
class AdsAnalyticsCreateAsyncRequest(ModelComposed):
    ...
    attribute_map = {
        ...
        'primary_sort': 'primary_sort',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            report_format (str): Specification for formatting the report data. Reports in JSON will not zero-fill metrics, whereas reports in CSV will. Both report formats will omit rows where all the columns are equal to 0.. [optional] if omitted the server will use the default value of "JSON"  # noqa: E501
            primary_sort (str): [optional] if omitted the server will use the default value of "BY_ID"  # noqa: E501
            start_hour (int): Which hour of the start date to begin the report. The entire day will be included if no start hour is provided. Only allowed for hourly reports.. [optional]  # noqa: E501
            end_hour (int): Which hour of the end date to stop the report (inclusive). For example, with an end_date of '2020-01-01' and end_hour of '15', the report will contain metrics up to '2020-01-01 14:59:59'. The entire day will be included if no end hour is provided. Only allowed for hourly reports.. [optional]  # noqa: E501
            ...
            campaign_objective_types ([ObjectiveType]): List of values for filtering. [\"WEB_SESSIONS\"] in BETA.. [optional]  # noqa: E501
            ...
            ad_ids ([str]): List of ad ids [This parameter is no supported for Product Item Level Reports]. [optional]  # noqa: E501
            ad_statuses ([PinPromotionSummaryStatus]): List of values for filtering [This parameter is not supported for Product Item Level Reports]. [optional]  # noqa: E501
