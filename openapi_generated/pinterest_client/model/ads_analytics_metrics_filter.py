...
class AdsAnalyticsMetricsFilter(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'field': (AdsAnalyticsFilterColumn,),  # noqa: E501
            'operator': (AdsAnalyticsFilterOperator,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, field, operator, values, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, field, operator, values, *args, **kwargs):  # noqa: E501
        """AdsAnalyticsMetricsFilter - a model defined in OpenAPI
