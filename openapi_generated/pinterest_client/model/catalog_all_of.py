...
class CatalogAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, catalog_type, *args, **kwargs):  # noqa: E501
        """CatalogAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, catalog_type, *args, **kwargs):  # noqa: E501
        """CatalogAllOf - a model defined in OpenAPI
