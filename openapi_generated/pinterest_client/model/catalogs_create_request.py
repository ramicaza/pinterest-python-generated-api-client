...
class CatalogsCreateRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, name, *args, **kwargs):  # noqa: E501
        """CatalogsCreateRequest - a model defined in OpenAPI

        Args:
            name (str): A human-friendly name associated to a given catalog.

        Keyword Args:
            catalog_type (str): Type of the catalog entity.. defaults to "HOTEL", must be one of ["HOTEL", ]  # noqa: E501
