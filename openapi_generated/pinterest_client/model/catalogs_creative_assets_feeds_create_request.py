...
class CatalogsCreativeAssetsFeedsCreateRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, format, default_locale, default_country, location, catalog_type, *args, **kwargs):  # noqa: E501
        """CatalogsCreativeAssetsFeedsCreateRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, format, default_locale, default_country, location, catalog_type, *args, **kwargs):  # noqa: E501
        """CatalogsCreativeAssetsFeedsCreateRequest - a model defined in OpenAPI
