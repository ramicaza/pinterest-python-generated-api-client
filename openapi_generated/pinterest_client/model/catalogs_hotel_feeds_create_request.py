...
class CatalogsHotelFeedsCreateRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, format, default_locale, location, catalog_type, *args, **kwargs):  # noqa: E501
        """CatalogsHotelFeedsCreateRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            catalog_id (str, none_type): Catalog id pertaining to the feed. If not provided, feed will use a default catalog based on type. At the moment a catalog can not have multiple hotel feeds but this will change in the future.. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, format, default_locale, location, catalog_type, *args, **kwargs):  # noqa: E501
        """CatalogsHotelFeedsCreateRequest - a model defined in OpenAPI
