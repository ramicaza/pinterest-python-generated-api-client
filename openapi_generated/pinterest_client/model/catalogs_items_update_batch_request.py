...
class CatalogsItemsUpdateBatchRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'items': ([ItemUpdateBatchRecord],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, country, language, operation, items, *args, **kwargs):  # noqa: E501
        """CatalogsItemsUpdateBatchRequest - a model defined in OpenAPI

        Args:
            country (Country):
            language (bool, date, datetime, dict, float, int, list, str, none_type): We recommend using the CatalogsLocale values.
            operation (BatchOperation):
            items ([ItemUpdateBatchRecord]): Array with catalogs items
