...
class CatalogsListProductsByFilterRequestOneOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, feed_id, filters, *args, **kwargs):  # noqa: E501
        """CatalogsListProductsByFilterRequestOneOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, feed_id, filters, *args, **kwargs):  # noqa: E501
        """CatalogsListProductsByFilterRequestOneOf - a model defined in OpenAPI
