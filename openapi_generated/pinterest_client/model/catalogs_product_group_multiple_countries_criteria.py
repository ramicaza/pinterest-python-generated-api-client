...
class CatalogsProductGroupMultipleCountriesCriteria(ModelNormal):
    ...
    def _from_openapi_data(cls, values, *args, **kwargs):  # noqa: E501
        """CatalogsProductGroupMultipleCountriesCriteria - a model defined in OpenAPI
