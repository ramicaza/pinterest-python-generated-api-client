...
class CatalogsRetailFeedsCreateRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, format, default_locale, location, catalog_type, default_country, *args, **kwargs):  # noqa: E501
        """CatalogsRetailFeedsCreateRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, format, default_locale, location, catalog_type, default_country, *args, **kwargs):  # noqa: E501
        """CatalogsRetailFeedsCreateRequest - a model defined in OpenAPI
