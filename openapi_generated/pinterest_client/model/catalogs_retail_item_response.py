...
def lazy_import():
    ...
    globals()['ItemAttributes'] = ItemAttributes
    globals()['Pin'] = Pin


class CatalogsRetailItemResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'attributes': (ItemAttributes,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, catalog_type, *args, **kwargs):  # noqa: E501
        """CatalogsRetailItemResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            item_id (str): The catalog retail item id in the merchant namespace. [optional]  # noqa: E501
            pins ([Pin], none_type): The pins mapped to the item. [optional]  # noqa: E501
            attributes (ItemAttributes): [optional]  # noqa: E501
        """
