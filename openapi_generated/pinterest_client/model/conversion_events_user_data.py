...
class ConversionEventsUserData(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'click_id': (str, none_type,),  # noqa: E501
            'partner_id': (str, none_type,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            ph ([str]): Sha256 hashes of user's phone numbers, only digits with country code, area code, and number. Remove any symbols, letters, spaces and leading zeros. We highly recommend this on checkout events at least. It may improve reporting performance such as ROAS/CPA. The string should be in the UTF-8 format.. [optional]  # noqa: E501
            ge ([str]): Sha256 hashes of user's gender, in lowercase. Either \"f\" or \"m\" or \"n\" for non-binary gender. The string should be in the UTF-8 format.. [optional]  # noqa: E501
            db ([str]): Sha256 hashes of user's date of birthday, given as year, month, and day. The string should be in the UTF-8 format.. [optional]  # noqa: E501
            ln ([str]): Sha256 hashes of user's last name, in lowercase. We highly recommend this on checkout events at least. It may improve reporting performance such as ROAS/CPA. The string should be in the UTF-8 format.. [optional]  # noqa: E501
            fn ([str]): Sha256 hashes of user's first name, in lowercase. We highly recommend this on checkout events at least. It may improve reporting performance such as ROAS/CPA. The string should be in the UTF-8 format.. [optional]  # noqa: E501
            ct ([str]): Sha256 hashes of user's city, in lowercase, and without spaces or punctuation. User residency city (mostly billing). The string should be in the UTF-8 format.. [optional]  # noqa: E501
            st ([str]): Sha256 hashes of user's state, given as a two-letter code in lowercase. User residency state (mostly billing). The string should be in the UTF-8 format.. [optional]  # noqa: E501
            zp ([str]): Sha256 hashes of user's zipcode, only digits. User residency zipcode (mostly billing). The string should be in the UTF-8 format.. [optional]  # noqa: E501
            country ([str]): Sha256 hashes of two-character ISO-3166 country code indicating the user's country, in lowercase. The string should be in the UTF-8 format.. [optional]  # noqa: E501
            external_id ([str]): Sha256 hashes of the unique id from the advertiser that identifies a user in their space, e.g. user id, loyalty id, etc. We highly recommend this on all events. It may improve reporting performance such as ROAS/CPA. The string should be in the UTF-8 format.. [optional]  # noqa: E501
            ...
            partner_id (str, none_type): A unique identifier of visitors' information defined by third party partners. e.g RampID. [optional]  # noqa: E501
        """
