...
class FeedFields2(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, format, catalog_type, credentials, location, preferred_processing_schedule, status, default_currency, default_locale, default_country, default_availability, *args, **kwargs):  # noqa: E501
        """FeedFields2 - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, format, catalog_type, credentials, location, preferred_processing_schedule, status, default_currency, default_locale, default_country, default_availability, *args, **kwargs):  # noqa: E501
        """FeedFields2 - a model defined in OpenAPI
