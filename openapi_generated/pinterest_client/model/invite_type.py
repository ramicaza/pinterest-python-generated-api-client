...
class InviteType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """InviteType - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): The type of invite. <br>'MEMBER_INVITE' is to invite a member to access your business assets. <br>'PARTNER INVITE' is to invite a partner to access your business assets. <br>'PARTNER_REQUEST' is to request access a partner's business assets.., must be one of ["MEMBER_INVITE", "PARTNER_INVITE", "PARTNER_REQUEST", ]  # noqa: E501
