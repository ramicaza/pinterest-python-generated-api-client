...
def lazy_import():
    ...
    globals()['ItemAttributesRequestAllOf'] = ItemAttributesRequestAllOf
    globals()['UpdatableItemAttributes'] = UpdatableItemAttributes


class ItemAttributesRequest(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'image_link': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'video_link': (str, none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ItemAttributesRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            video_link (str, none_type): <p><= 2,000 characters</p> <p>Hosted link to the product video.</p> <p>File types for linked videos must be .mp4, .mov or .m4v.</p> <p>File size cannot exceed 2GB.</p>. [optional]  # noqa: E501
