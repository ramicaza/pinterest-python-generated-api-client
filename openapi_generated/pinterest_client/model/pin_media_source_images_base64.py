...
def lazy_import():
    ...
    globals()['PinMediaSourceImagesBase64Items'] = PinMediaSourceImagesBase64Items


class PinMediaSourceImagesBase64(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([PinMediaSourceImagesBase64Items],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """PinMediaSourceImagesBase64 - a model defined in OpenAPI

        Args:
            items ([PinMediaSourceImagesBase64Items]): Array with image objects.
        ...
        Keyword Args:
            ...
            source_type (str): [optional] if omitted the server will use the default value of "multiple_image_base64"  # noqa: E501
