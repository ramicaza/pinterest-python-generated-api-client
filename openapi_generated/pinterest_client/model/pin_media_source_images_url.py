...
class PinMediaSourceImagesURL(ModelNormal):
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """PinMediaSourceImagesURL - a model defined in OpenAPI

        Args:
            items ([PinMediaSourceImagesURLItems]): Array with image objects.
