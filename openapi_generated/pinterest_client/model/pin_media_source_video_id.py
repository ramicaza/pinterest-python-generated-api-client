...
class PinMediaSourceVideoID(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, media_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            source_type (str): defaults to "video_id", must be one of ["video_id", ]  # noqa: E501
        ...
        source_type = kwargs.get('source_type', "video_id")
    ...
    @convert_js_args_to_python_args
    def __init__(self, media_id, *args, **kwargs):  # noqa: E501
        """PinMediaSourceVideoID - a model defined in OpenAPI
